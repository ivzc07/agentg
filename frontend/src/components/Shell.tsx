...
export function Shell({ name, gym }: ShellProps) {
  ...
  return (
    <div className="min-h-screen bg-bg text-ink font-sans antialiased">
      ...
      <header className="sticky top-0 z-20 flex items-center gap-1.5 flex-wrap min-h-[46px] px-gut py-1.5 bg-elevation-0 border-b border-elevation-0-stroke shadow-shadow-1">
