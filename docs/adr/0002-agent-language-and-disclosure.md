...
- **Status:** Accepted
- **Date:** 2026-07-18
- **Decision drivers:** Product owner wants the Agent to speak Spanish for a Spanish-first market (flowstate.mx). Amends the disclaimer rule from [Define safety rules (#20)](https://github.com/ivzc07/agentg/issues/20) / spec §Safety rules.
